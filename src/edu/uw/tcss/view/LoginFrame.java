...
import edu.uw.tcss.io.CredentialingLoader;
...
public class LoginFrame extends JFrame {
     ...
     *
     */
    private final class AttemptRegistrationWorker extends SwingWorker<String, Integer> {
     ...
     *
     */
    private final class AttemptLoginWorker extends SwingWorker<String, Integer> {
